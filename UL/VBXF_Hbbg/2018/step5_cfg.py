...
# with command line options: step5 --filein file:step4.root --fileout file:step5.root --mc --eventcontent AODSIM --runUnscheduled --datatier AODSIM --conditions 106X_upgrade2018_realistic_v11_L1v1 --step RAW2DIGI,L1Reco,RECO,RECOSIM,EI --nThreads 4 --geometry DB:Extended --era Run2_2018 --python_filename step5_cfg.py --no_exec --customise Configuration/DataProcessing/Utils.addMonitoring -n 500
...
process.configurationMetadata = cms.untracked.PSet(
    annotation = cms.untracked.string('step5 nevts:500'),
