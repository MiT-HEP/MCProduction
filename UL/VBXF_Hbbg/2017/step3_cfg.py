...
# with command line options: step3 --filein file:step2.root --fileout file:step3.root --pileup_input file:XXX --mc --eventcontent PREMIXRAW --runUnscheduled --datatier GEN-SIM-DIGI --conditions 106X_mc2017_realistic_v6 --step DIGI,DATAMIX,L1,DIGI2RAW --procModifiers premix_stage2 --nThreads 4 --geometry DB:Extended --datamix PreMix --era Run2_2017 --python_filename step3_cfg.py --no_exec --customise Configuration/DataProcessing/Utils.addMonitoring -n 500
...
# Other statements
#process.mixData.input.fileNames = cms.untracked.vstring(['file:XXX'])
