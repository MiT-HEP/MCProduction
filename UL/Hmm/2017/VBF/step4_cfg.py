...
# with command line options: step1 --filein file:step3.root --fileout file:step4.root --mc --eventcontent RAWSIM --datatier GEN-SIM-RAW --conditions 94X_mc2017_realistic_v15 --customise_commands process.source.bypassVersionCheck = cms.untracked.bool(True) --step HLT:2e34v40 --nThreads 8 --geometry DB:Extended --era Run2_2017 --python_filename step4_cfg.py --no_exec --customise Configuration/DataProcessing/Utils.addMonitoring -n 500
