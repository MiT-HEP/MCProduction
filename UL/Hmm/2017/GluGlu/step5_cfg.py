...
# with command line options: step1 --filein file:step4.root --fileout file:step5.root --mc --eventcontent AODSIM --runUnscheduled --datatier AODSIM --conditions 106X_mc2017_realistic_v6 --step RAW2DIGI,L1Reco,RECO,RECOSIM --nThreads 8 --geometry DB:Extended --era Run2_2017 --python_filename step5_cfg.py --no_exec --customise Configuration/DataProcessing/Utils.addMonitoring -n 500
