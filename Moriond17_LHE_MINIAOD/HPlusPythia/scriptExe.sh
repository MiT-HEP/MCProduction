...
# Configuration/GenProduction/python/PYTHIA_ChargedHToTauNu_mH140_13TeV_cff.py --fileout file:step1.root --mc  --eventcontent RAWSIM --customise SLHCUpgradeSimulations/Configuration/postLS1Customs.customisePostLS1,Configuration/DataProcessing/Utils.addMonitoring --datatier GEN-SIM --conditions MCRUN2_71_V1::All --beamspot Realistic50ns13TeVCollision --step GEN,SIM --magField 38T_PostLS1 --python_filename step1.py  --no_exec -n 500

cmsRun -j GenSimAODSim_step1.log step1.py jobNum=$1
mv step1.root step2.root 
...
cmsDriver.py step5 --fileout file:step5.root --filein file:step4.root --mc --eventcontent MINIAODSIM --runUnscheduled --datatier MINIAODSIM --conditions 80X_mcRun2_asymptotic_2016_TrancheIV_v6 --step PAT --nThreads 4 --era Run2_2016 --python_filename step5.py --no_exec --customise Configuration/DataProcessing/Utils.addMonitoring -n ${NUM} || exit $? ; 
