...
# with command line options: step5 --fileout file:step5.root --mc --eventcontent MINIAODSIM --runUnscheduled --datatier MINIAODSIM --conditions 80X_mcRun2_asymptotic_2016_TrancheIV_v6 --step PAT --nThreads 4 --era Run2_2016 --python_filename MINIAODSIM.py --no_exec --customise Configuration/DataProcessing/Utils.addMonitoring -n 500
...
##    fileNames = cms.untracked.vstring('file:step5_RECO.root'),
