...
# with command line options: --python_filename step7_cfg.py --eventcontent NANOAODSIM --customise Configuration/DataProcessing/Utils.addMonitoring --datatier NANOAODSIM --fileout file:step7.root --conditions 106X_mcRun2_asymptotic_v17 --step NANO --filein file:step6.root --era Run2_2016,run2_nanoAOD_106Xv2 --no_exec --mc -n -1
