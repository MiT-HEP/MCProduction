...
config.General.requestName = 'amarini_UL2016_nanoAODv9'
...
config.Data.outputDatasetTag ='UL2016-NANOAODSIMv9'
...
if do=='ggh_hbbg' :
    config.General.requestName = 'amarini-UL2016_GGHMH125_amcatnlo'
...
for iht in xrange(0,len(htarray)-1):
    ...
    if do=='qcd_ht_'+ht+'_'+htn+'_bfilter':
        config.General.requestName = 'amarini_UL2016_QCD_HT'+ht+'to'+htn+'_BGenFilter_TuneCP5_13TeV-madgraph-pythia8'
...
if do.startswith("mssm_gghhmm"):
    ...
    config.General.requestName = 'amarini_UL2016_'+ 'MSSMGluGluToHToMuMu_MA-'+ma+'_Tanb-'+tb+'_TuneCP5_13TeV-powheg-pythia8'
...
if do.startswith("mssm_ggahmm"):
    ...
    tb=re.sub('tb','',do.split("_")[3])
    config.Data.totalUnits = 10000
    config.General.requestName = 'amarini_UL2016_'+ 'MSSMGluGluToAToMuMu_MA-'+ma+'_Tanb-'+tb+'_TuneCP5_13TeV-powheg-pythia8'
...
if do.startswith("mssm_bbhhmm"):
    ...
    tb=re.sub('tb','',do.split("_")[3])
    config.Data.totalUnits = 10000
    config.General.requestName = 'amarini_UL2016_'+ 'MSSMBBToHToMuMu_MA-'+ma+'_Tanb-'+tb+'_TuneCP5_13TeV-powheg-pythia8'
...
if do.startswith("mssm_bbahmm"):
    ...
    tb=re.sub('tb','',do.split("_")[3])
    config.Data.totalUnits = 10000
    config.General.requestName = 'amarini_UL2016_'+ 'MSSMBBToAToMuMu_MA-'+ma+'_Tanb-'+tb+'_TuneCP5_13TeV-powheg-pythia8'
    config.Data.outputPrimaryDataset = 'MSSMBBToAToMuMu_MA-'+ma+'_Tanb-'+tb+'_TuneCP5_13TeV-powheg-pythia8'
    config.JobType.scriptArgs=['chain='+do]

## wpjj_wmjj_{ewk,qcd,ewk_qcd}
## wpmjj_wpmjj
## zbb_wpmjj
## zjjnob_wpmjj
## zjjzjj
