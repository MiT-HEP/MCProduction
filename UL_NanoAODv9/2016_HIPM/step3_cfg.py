...
# with command line options: --python_filename step3_cfg.py --eventcontent PREMIXRAW --customise Configuration/DataProcessing/Utils.addMonitoring --datatier GEN-SIM-DIGI --fileout file:step3.root --pileup_input file:XXX --conditions 106X_mcRun2_asymptotic_preVFP_v8 --step DIGI,DATAMIX,L1,DIGI2RAW --procModifiers premix_stage2 --geometry DB:Extended --filein file:step2.root --datamix PreMix --era Run2_2016_HIPM --runUnscheduled --no_exec --mc -n -1
