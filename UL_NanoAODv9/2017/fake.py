...
# with command line options: --python_filename step7_cfg.py --eventcontent NANOAODSIM --customise Configuration/DataProcessing/Utils.addMonitoring --datatier NANOAODSIM --fileout file:step7.root --conditions 106X_mc2017_realistic_v8 --step NANO --filein file:step6.root --era Run2_2017,run2_nanoAOD_106Xv1 --no_exec --mc -n 500
