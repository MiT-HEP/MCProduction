...
config.Data.outputDatasetTag ='UL2017-NANOAODSIMv9'
...
if do=='hwz1000' :
    config.General.requestName = 'amarini_UL2017_SinglyChargedHiggsGMmodel_HWZ_Znn_M1000_madgraph'
...
if do=='hwz2000' :
    config.General.requestName = 'amarini_UL2017_SinglyChargedHiggsGMmodel_HWZ_Znn_M2000_madgraph'
...
if do=='hwz3000' :
    config.General.requestName = 'amarini_UL2017_SinglyChargedHiggsGMmodel_HWZ_Znn_M3000_madgraph'
...
if do=='hww1500' :
    config.General.requestName = 'amarini_UL2017_DoublyChargedHiggsGMmodel_HWW_M1500_13TeV-madgraph'
...
if do=='hww1000' :
    config.General.requestName = 'amarini_UL2017_DoublyChargedHiggsGMmodel_HWW_M1000_13TeV-madgraph'
...
if do=='hww2000' :
    config.General.requestName = 'amarini_UL2017_DoublyChargedHiggsGMmodel_HWW_M2000_13TeV-madgraph'
...
if do=='hww3000' :
    config.General.requestName = 'amarini_UL2017_DoublyChargedHiggsGMmodel_HWW_M3000_13TeV-madgraph'
...
if do=='hwz_zbb_1500' :
    config.General.requestName = 'amarini_UL2017_SinglyChargedHiggsGMmodel_HWZ_Zbb_M1500_madgraph'
...
if do=='hwz_zbb_1000' :
    config.General.requestName = 'amarini_UL2017_SinglyChargedHiggsGMmodel_HWZ_Zbb_M1000_madgraph'
...
if do=='hwz_zbb_2000' :
    config.General.requestName = 'amarini_UL2017_SinglyChargedHiggsGMmodel_HWZ_Zbb_M2000_madgraph'
...
if do=='hwz_zbb_3000' :
    config.General.requestName = 'amarini_UL2017_SinglyChargedHiggsGMmodel_HWZ_Zbb_M3000_madgraph'
...
if do=='WWjj_ss_pol_hadronic_ll' :
    config.General.requestName = 'amarini_UL2017_WWjj_SS_ll_hadronic'
...
if do=='WWjj_ss_pol_hadronic_lt' :
    config.General.requestName = 'amarini_UL2017_WWjj_SS_lt_hadronic'
...
if do=='WWjj_ss_pol_hadronic_tt' :
    config.General.requestName = 'amarini_UL2017_WWjj_SS_tt_hadronic'
...
if do=='hww1000_semilep' :
    config.General.requestName = 'amarini_UL2017_DoublyChargedHiggsGMmodel_HWW_semilep_M1000_13TeV-madgraph'
...
if do=='hww2000_semilep' :
    config.General.requestName = 'amarini_UL2017_DoublyChargedHiggsGMmodel_HWW_semilep_M2000_13TeV-madgraph'
...
if do=='vbs_hbb_wpmjj_qcd':
    config.General.requestName = 'amarini_UL2017_HBBWPMJJjj_QCD_LO_TuneCP5_13TeV-madgraph-pythia8'
...
for iht in xrange(0,len(htarray)-1):
    ...
    if do=='qcd_ht_'+ht+'_'+htn+'_bfilter':
        config.General.requestName = 'amarini_UL2017_QCD_HT'+ht+'to'+htn+'_BGenFilter_TuneCP5_13TeV-madgraph-pythia8'
...
if do.startswith("mssm_gghhmm"):
    ...
    config.General.requestName = 'amarini_UL2017_'+ 'MSSMGluGluToHToMuMu_MA-'+ma+'_Tanb-'+tb+'_TuneCP5_13TeV-powheg-pythia8'
...
if do.startswith("mssm_ggahmm"):
    ...
    tb=re.sub('tb','',do.split("_")[3])
    config.Data.totalUnits = 10000
    config.General.requestName = 'amarini_UL2017_'+ 'MSSMGluGluToAToMuMu_MA-'+ma+'_Tanb-'+tb+'_TuneCP5_13TeV-powheg-pythia8'
