...
# with command line options: --python_filename step4_cfg.py --eventcontent RAWSIM --customise Configuration/DataProcessing/Utils.addMonitoring --datatier GEN-SIM-RAW --fileout file:step4.root --conditions 94X_mc2017_realistic_v15 --customise_commands process.source.bypassVersionCheck = cms.untracked.bool(True) --step HLT:2e34v40 --geometry DB:Extended --filein file:step3.root --era Run2_2017 --no_exec --mc -n 500
