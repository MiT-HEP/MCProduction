...
config.Data.outputDatasetTag ='UL2018-NANOAODSIMv9'
...
if do=='hbbg' :
    config.General.requestName = 'amarini-UL2018_GGHMH125_amcatnlo'
...
if do=='vbs_hbb_wpmjj_ewk':
    config.General.requestName = 'amarini_UL2018_HBBWPMJJjj_EWK_LO_TuneCP5_13TeV-madgraph-pythia8'
...
if do=='vbs_hbb_wpmjj_qcd':
    config.General.requestName = 'amarini_UL2018_HBBWPMJJjj_QCD_LO_TuneCP5_13TeV-madgraph-pythia8'
...
for iht in xrange(0,len(htarray)-1):
    ...
    if do=='qcd_ht_'+ht+'_'+htn+'_bfilter':
        config.General.requestName = 'amarini_UL2018_QCD_HT'+ht+'to'+htn+'_BGenFilter_TuneCP5_13TeV-madgraph-pythia8'
...
if do.startswith("mssm_gghhmm"):
    ...
    config.General.requestName = 'amarini_UL2018_'+ 'MSSMGluGluToHToMuMu_MA-'+ma+'_Tanb-'+tb+'_TuneCP5_13TeV-powheg-pythia8'
...
if do.startswith("mssm_ggahmm"):
    ...
    tb=re.sub('tb','',do.split("_")[3])
    config.Data.totalUnits = 10000
    config.General.requestName = 'amarini_UL2018_'+ 'MSSMGluGluToAToMuMu_MA-'+ma+'_Tanb-'+tb+'_TuneCP5_13TeV-powheg-pythia8'
...
if do.startswith("mssm_bbhhmm"):
    ...
    tb=re.sub('tb','',do.split("_")[3])
    config.Data.totalUnits = 10000
    config.General.requestName = 'amarini_UL2018_'+ 'MSSMBBToHToMuMu_MA-'+ma+'_Tanb-'+tb+'_TuneCP5_13TeV-powheg-pythia8'
...
if do.startswith("mssm_bbahmm"):
    ...
    tb=re.sub('tb','',do.split("_")[3])
    config.Data.totalUnits = 10000
    config.General.requestName = 'amarini_UL2018_'+ 'MSSMBBToAToMuMu_MA-'+ma+'_Tanb-'+tb+'_TuneCP5_13TeV-powheg-pythia8'
