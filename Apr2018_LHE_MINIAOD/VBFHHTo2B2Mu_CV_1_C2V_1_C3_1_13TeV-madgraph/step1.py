...
# with command line options: Configuration/GenProduction/HIG-RunIIFall17wmLHEGS-01193-fragment.py --fileout file:step1.root --mc --eventcontent RAWSIM,LHE --datatier GEN-SIM,LHE --conditions 93X_mc2017_realistic_v3 --beamspot Realistic25ns13TeVEarly2017Collision --step LHE,GEN,SIM --nThreads 8 --geometry DB:Extended --era Run2_2017 --python_filename step1.py --no_exec --customise Configuration/DataProcessing/Utils.addMonitoring -n 500
...
process.configurationMetadata = cms.untracked.PSet(
    annotation = cms.untracked.string('Configuration/GenProduction/HIG-RunIIFall17wmLHEGS-01193-fragment.py nevts:500'),
...
process.externalLHEProducer = cms.EDProducer("ExternalLHEProducer",
    args = cms.vstring('/cvmfs/cms.cern.ch/phys_generator/gridpacks/2017/13TeV/madgraph/V5_2.6.0/VBF_HH_CV_1_C2V_1_C3_1_13TeV-madgraph_slc6_amd64_gcc481_CMSSW_7_1_30/v1/VBF_HH_CV_1_C2V_1_C3_1_13TeV-madgraph_slc6_amd64_gcc481_CMSSW_7_1_30_tarball.tar.xz'),
