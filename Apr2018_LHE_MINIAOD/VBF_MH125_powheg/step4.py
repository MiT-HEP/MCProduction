...
# with command line options: step4 --fileout file:step4.root --filein file:step3.root --mc --eventcontent MINIAODSIM --runUnscheduled --datatier MINIAODSIM --conditions 94X_mc2017_realistic_v14 --step PAT --nThreads 1 --scenario pp --era Run2_2017,run2_miniAOD_94XFall17 --python_filename step4.py --no_exec --customise Configuration/DataProcessing/Utils.addMonitoring -n 500
