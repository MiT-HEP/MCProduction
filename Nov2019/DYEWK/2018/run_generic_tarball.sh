...
## echo "Removing weights"
## sed -i'' '/^<initrwgt>/,/^</initrwgt>/{/^<initrwgt>/!{/^</initrwgt>/!d}}' cmsgrid_final.lhe
## sed -i'' '/^<rwgt>/,/^</rwgt>/{/^<rwgt>/!{/^</rwgt>/!d}}' cmsgrid_final.lhe

echo "Removing comments"
sed -i'' '/LUXqed17_plus_PDF4LHC15_nnlo_100/,/LUXqed17\ paper/{/LUXqed17_plus_PDF4LHC15_nnlo_100/!d}' cmsgrid_final.lhe
sed -i'' -e '/^<initrwgt>/,/^<\/initrwgt>/s/#.*//' cmsgrid_final.lhe
