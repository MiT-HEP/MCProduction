...
config.General.requestName = 'amarini_FullSim_DoublyChargedHiggsGMmodel_M1500'
...
config.Data.outputPrimaryDataset = 'SinglyChargedHiggsGMmodel_HWZ_M1500_13TeV-madgraph'
