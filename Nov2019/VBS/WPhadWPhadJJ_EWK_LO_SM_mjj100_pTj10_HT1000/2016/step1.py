...
import os
print "-> Using gridpack",os.environ['PWD']+'/WPhadWPhadJJ_EWK_LO_SM_mjj100_pTj10_HT1000_slc6_amd64_gcc630_CMSSW_9_3_16_tarball.tar.xz'
...
process.externalLHEProducer = cms.EDProducer("ExternalLHEProducer",
    ...
    args = cms.vstring(os.environ['PWD']+'/WPhadWPhadJJ_EWK_LO_SM_mjj100_pTj10_HT1000_slc6_amd64_gcc630_CMSSW_9_3_16_tarball.tar.xz')
)
...
print "-> setting seeds:"
print "   LHE",process.RandomNumberGeneratorService.externalLHEProducer.initialSeed
print "   GEN",process.RandomNumberGeneratorService.generator.initialSeed
